 ...
 *
 * Vive aparte del componente porque tiene tres consumidores: el Accordion de la
 * landing, el esquema FAQPage de schema.org y el prerender de HTML estatico. El
 * Accordion de Radix desmonta las respuestas cerradas, asi que sin este modulo
 * el texto de las respuestas no existiria para ningun buscador.
 */
