  ...
  welcome: (d) => `
    <div style="font-family:'Segoe UI',Arial,sans-serif;max-width:600px;margin:0 auto;color:#e2e8f0;background:#0f172a;">
      <div style="background:linear-gradient(135deg,#0f172a,#1e293b);padding:32px;text-align:center;">
        <h1 style="color:#f8fafc;margin:0;font-size:24px;">S.S.S</h1>
        <p style="color:#94a3b8;margin:8px 0 0;font-size:14px;">Security Smart Services</p>
      </div>
      <div style="padding:32px;background:#1e293b;">
        <h2 style="color:#f8fafc;margin:0 0 16px;">¡Bienvenido/a, ${d.full_name}!</h2>
        <p style="color:#94a3b8;line-height:1.6;">Tu cuenta ha sido creada exitosamente en S.S.S.</p>
      ...
      <div style="padding:16px;text-align:center;font-size:11px;color:#475569;background:#0f172a;">S.S.S Security Smart Services</div>
    </div>`,
  ...
  test: () => `
    <div style="font-family:'Segoe UI',Arial,sans-serif;max-width:600px;margin:0 auto;color:#e2e8f0;background:#0f172a;">
      ...
      <div style="padding:32px;background:#1e293b;text-align:center;">
        ...
        <p style="color:#94a3b8;line-height:1.6;">Este es un email de prueba de S.S.S. Si puedes leer este mensaje, tu configuración de correo funciona correctamente.</p>
      </div>
      <div style="padding:16px;text-align:center;font-size:11px;color:#475569;background:#0f172a;">S.S.S Security Smart Services</div>
    </div>`,
};
